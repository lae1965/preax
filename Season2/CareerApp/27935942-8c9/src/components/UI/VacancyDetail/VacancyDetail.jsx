...
import { SceletonVacancyDetail } from './SceletonVacancyDetail';

export const VacancyDetail = () => {
  const { vacancyDetail, loadDetail } = useDetailVacancyStore();
  ...
  if (loadDetail) return <SceletonVacancyDetail />;
  return (
      ...
      <div className={styles.leftSide}>
        ...
        <div className={styles.skillBlock}>
          ...
          <div className={styles.published}>
            Вакансия опубликована {vacancyDetail.published_at} в г.{' '}
            {vacancyDetail.area}
          </div>
        </div>
      </div>
