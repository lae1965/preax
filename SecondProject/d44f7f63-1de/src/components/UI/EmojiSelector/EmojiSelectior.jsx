...
const EmojiSelector = () => {
  ...
  return (
    <div
      ref={selectorRef}
      className={`${styles.selector} ${isOpen ? styles.open : ''} ${isOpen ? styles.focus : ''}`} // Добавляем условие для класса 'focus'
      onClick={toggleDropdown}
    >
      <div className={styles.emoji}>{selectedEmoji || <SelectorDefaultSmile />}</div>
