interface IconEyeClosedProps extends React.SVGAttributes<SVGSVGElement> {}

export const IconEyeClosed: React.FC<IconEyeClosedProps> = (props) => {
	return (
		<svg
